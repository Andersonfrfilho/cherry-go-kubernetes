...
cd api;kubectl apply -f .\deployment.yaml;kubectl apply -f .\configmap-env.yaml; kubectl apply -f .\hpa.yaml;kubectl apply -f .\secret.yaml;kubectl apply -f .\service.yaml;
...
aguardar o load balancer ser liberado para adicionar no seu dns
